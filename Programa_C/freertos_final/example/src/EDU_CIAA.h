...
#define _GPDMA			((GPDMA_T	*)	GPDMA_BASE)
...
/************************************************************************************
 *	Digital to Analogic Converter (DAC)												*
 ************************************************************************************/

#define DAC_BASE			0x400E1000	// DAC Base Address
...
// Digital to Analogic Converter Register
typedef struct {
	int CR;					//Offset: 0x000 (R/W)
	int	CTRL;				//Offset: 0x004 (R/W)
	int CNTVAL;				//Offset: 0x008 (R/W)
} DAC_T;
...
#define SSP0_BASE		0x40083000
#define SSP1_BASE		0x400C5000
#define SSP0			((SSP_t	*) SSP0_BASE)
#define SSP1			((SSP_t	*) SSP1_BASE)
...
// Funciones para trabajar a los registros
void GPIO_SetPin(GPIO_T *pGPIO, unsigned char puerto, unsigned char pin, char valor );
